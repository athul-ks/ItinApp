        ...
        <div className="container grid gap-8 px-4 sm:grid-cols-2 md:px-6 lg:grid-cols-3">
          <Card className="shadow-lg transition-shadow duration-300 hover:shadow-xl">
            ...
            <CardDescription className="p-6 pt-0">
              We find the hidden gems and top tourist spots, so you can experience the best of your
              destination.
            </CardDescription>
          </Card>
          <Card className="shadow-lg transition-shadow duration-300 hover:shadow-xl">
            ...
            <CardDescription className="p-6 pt-0">
              Optimized routes so you don&apos;t waste time traveling back and forth. Make the most
              of every moment.
            </CardDescription>
          </Card>
          <Card className="shadow-lg transition-shadow duration-300 hover:shadow-xl">
